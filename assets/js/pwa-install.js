(function () {
    ...
    function detectInstructionTarget() {
        ...
        if (/opera|opr\//i.test(userAgent)) return /android/i.test(userAgent) ? 'opera-android' : 'opera';
        if (/firefox\//i.test(userAgent)) return /android/i.test(userAgent) ? 'firefox-android' : 'firefox';
